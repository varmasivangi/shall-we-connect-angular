...
var VideoCallComponent = /** @class */ (function () {
    function VideoCallComponent(route, router, platformId) {
        var _this = this;
        this.route = route;
        this.router = router;
    ...
    VideoCallComponent.prototype.setupPeerConnection = function () {
        var _this = this;
        if (typeof window === 'undefined') {
    ...
    VideoCallComponent.prototype.generateMeetingLink = function () {
    ...
    VideoCallComponent.prototype.copyLink = function () {
        navigator.clipboard.writeText(this.meetingLink).then(function () {
        });
    };
    VideoCallComponent.prototype.joinMeeting = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, error_1;
            var _this = this;
    ...
    VideoCallComponent.prototype.listenForSignals = function () {
        var _this = this;
    ...
    VideoCallComponent.prototype.leaveMeeting = function () {
        if (this.localStream) {
    ...
    ], VideoCallComponent.prototype, "localVideo");
    __decorate([
        core_1.ViewChild('remoteVideo')
    ], VideoCallComponent.prototype, "remoteVideo");
